    ...
    */
    ...
    public function actualizar_detalle_kardex_importado($id_proveedor,$id_comprobante,$suma_parciales_factura,$id_detalle_producto,$cantidad_ingreso,$precio_ingreso,$fecharegistro,$seriecomprobante,$numcomprobante,$total_factura_contabilidad,$almacen)
    {
        ...
        if($query->num_rows()>0){
            ...
            $nuevo_precio_unitario = (($stock_referencial*$precio_unitario)+($cantidad_ingreso*$p_u_gastos))/($stock_referencial + $cantidad_ingreso);
            $actualizar = array(
...
*/
    ...
    public function getDataStock($nombre_producto,$id_area){
        ...
        $sql = "SELECT detalle_producto.no_producto,unidad_medida.nom_uni_med,producto.column_temp,detalle_producto_area.id_detalle_producto_area,
                detalle_producto_area.stock_area_sta_anita,detalle_producto_area.stock_area_sta_clara,detalle_producto_area.id_area
                FROM producto
                INNER JOIN detalle_producto ON producto.id_detalle_producto = detalle_producto.id_detalle_producto
                INNER JOIN unidad_medida ON producto.id_unidad_medida = unidad_medida.id_unidad_medida
    ...
    */
    ...
    function listarResumenProductos_report_excel(){
        $sql = "SELECT producto.id_pro,producto.id_producto,detalle_producto.no_producto,detalle_producto.stock,detalle_producto.precio_unitario,
        categoria.no_categoria,tipo_producto.no_tipo_producto,procedencia.no_procedencia,unidad_medida.nom_uni_med
        FROM
        producto
        INNER JOIN detalle_producto ON producto.id_detalle_producto = detalle_producto.id_detalle_producto
        INNER JOIN categoria ON producto.id_categoria = categoria.id_categoria
    ...
    */
    ...
    function eliminarSalidaProducto($id_salida_producto,$almacen)
    {
        ...
        $this->db->select('fecha,id_detalle_producto,cantidad_salida');
        ...
        if($query->num_rows()>0){
            ...
            $sql = "DELETE FROM kardex_producto WHERE id_kardex_producto = " . $id_kardex_producto . "";
            $query = $this->db->query($sql);
            return true;
        }
    }
    ...
    public function actualizaProducto(){
        ...
        */
            ...
            $this->db->insert('detalle_producto_area', $a_data);
