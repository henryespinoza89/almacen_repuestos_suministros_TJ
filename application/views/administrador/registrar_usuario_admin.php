    ...
    <div id="formFiltro">
      ...
      <!--Iniciar listar-->
        <?php 
          ...
          {
        ?>
        <table border="0" cellspacing="0" cellpadding="0" id="listaUsuarios" style="width:1370px;padding-top: 8px;" class="table table-hover table-striped" >
          <thead>
            <tr class="tituloTable" style="font-family: Helvetica Neu,Helvetica,Arial,sans-serif;font-size: 12px;height: 35px;">
              <td sort="idproducto" width="155" height="27">NOMBRES</td>
              <td sort="idproducto" width="155" height="27">APELLIDOS</td>
              <td sort="idproducto" width="230" height="27">CORREO ELECTRONICO</td>
              <td sort="nombreprod" width="120">ESTADO</td>
              <td sort="catprod" width="147">USUARIO</td>
              <td sort="procprod" width="147">TIPO DE USUARIO</td>
              <td sort="procprod" width="147">ALMACEN</td>
              <td sort="procprod" width="147">FECHA DE REGISTRO</td>
            </tr>
          </thead>
          <?php
            $i = 1;
          ...
          <tr class="contentTable" style="font-size: 12px;">
            <td height="27" style="vertical-align: middle;"><?php echo $listausuarios->no_usuario; ?></td>
