...
<body>
  <div id="contenedor">
    <div id="tituloCont">Categoría de Producto</div>
    <div id="formFiltro">
      <div id="options_productos">
        ...
        <table border="0" cellspacing="0" cellpadding="0" id="listaCategoriaProductos" style="float: left;width: 700px;" class="table table-hover table-striped">
          ...
          <tr class="contentTable" style="font-size: 12px;">
            ...
            <td width="20" align="center"><img class="delete_categoria_producto" src="<?php echo base_url();?>assets/img/trash.png" width="20" height="20" title="Eliminar Categoría de Producto" onClick="delete_categoria_producto(<?php echo $data->id_categoria; ?>)" style="cursor: pointer;"/></td>
          </tr>
          <?php
            $i++;
            } 
