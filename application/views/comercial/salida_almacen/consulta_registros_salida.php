      ...
      <form name="filtroBusqueda" action="#" method="post">
        ...
        <?php echo form_open(base_url()."comercial/gestionconsultarSalidaRegistros", 'id="buscar"') ?>
          <table width="300" border="0" cellspacing="0" cellpadding="0" style="float: left;">
            ...
            <tr>
              <td width="62" valign="middle" style="height:30px;">Marca:</td>
              <td>
                <select name="marca" id="marca" class='required' style='width:170px;'></select>
              </td>
            </tr>
            <tr>
              <td width="62" valign="middle" style="height:30px;">Modelo:</td>
              <td>
                <select name="modelo" id="modelo" class='required' style='width:170px;'></select>
              </td>
            </tr>
            <tr>
              <td width="62" valign="middle" style="height:30px;">Serie:</td>
              <td>
