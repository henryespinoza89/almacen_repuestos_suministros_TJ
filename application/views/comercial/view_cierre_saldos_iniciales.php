...
<body>
    <div id="contenedor" style="">
    	...
    	<div id="formFiltro" style="background: whitesmoke;padding-top: 5px;padding-left: 15px;padding-bottom: 10px;border-bottom: 1px solid #000;">
			<table width="550" border="0" cellspacing="0" cellpadding="0" style="margin-top: 10px;">
				<tr>
	            ...
	            <tr>
	            	<td width="180" colspan="2"><input name="submit" type="submit" id="cierre_almacen_saldos_iniciales" class="cierre_almacen_saldos_iniciales" value="Realizar Cierre de Saldos Iniciales" style="background-color: #4B8A08;width: 161px;margin-bottom: 6px;" /></td>
	            </tr>
			</table>
		</div>
