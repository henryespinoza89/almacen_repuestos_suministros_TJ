...
$(function(){
	...
	$("#edit_fr_compra").mask("9.999");
	$("#edit_fr_venta").mask("9.999");
});

</script>
<div id="contenedor" style="width:240px; height:230px;">
    	...
    	<form style="border-bottom:0px">
	    	...
	    	<?php
				...
				#Datos del USUARIO
					...
					$edit_fr_compra = array('name'=>'edit_fr_compra','id'=>'edit_fr_compra','maxlength'=>'5', 'value'=>$TC->fr_compra, 'style'=>'width:50px');
					$edit_fr_venta = array('name'=>'edit_fr_venta','id'=>'edit_fr_venta','maxlength'=>'5', 'value'=>$TC->fr_venta, 'style'=>'width:50px');
			?>
	    		<tr>
				...
				<tr>
					...
					<td width="245"><?php echo form_input($edit_fr_compra); ?></td>
				</tr>
				<tr>
					<td width="127">Venta Fr. Suizo:</td>
					<td width="245"><?php echo form_input($edit_fr_venta); ?></td>
				</tr>
			<?php }?>
	    	</table>
	 	</form>
